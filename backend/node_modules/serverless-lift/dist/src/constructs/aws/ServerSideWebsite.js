...
var import_aws_cloudfront2 = require("aws-cdk-lib/aws-cloudfront");
...
const _ServerSideWebsite = class extends import_abstracts.AwsConstruct {
  constructor(scope, id, configuration, provider) {
    ...
    const backendOriginPolicy = import_aws_cloudfront.OriginRequestPolicy.ALL_VIEWER_EXCEPT_HOST_HEADER;
    const backendCachePolicy = import_aws_cloudfront2.CachePolicy.CACHING_DISABLED;
    ...
    const originPath = configuration.apiGateway === "rest" ? "/" + ((_a = provider.getStage()) != null ? _a : "") : void 0;
    this.distribution = new import_aws_cloudfront2.Distribution(this, "CDN", {
      comment: `${provider.stackName} ${id} website CDN`,
      defaultBehavior: {
        // Origins are where CloudFront fetches content
        origin: new import_aws_cloudfront_origins.HttpOrigin(apiGatewayDomain, {
          // API Gateway only supports HTTPS
          protocolPolicy: import_aws_cloudfront2.OriginProtocolPolicy.HTTPS_ONLY,
          originPath
        }),
        // For a backend app we all all methods
        allowedMethods: import_aws_cloudfront2.AllowedMethods.ALLOW_ALL,
        cachePolicy: backendCachePolicy,
        viewerProtocolPolicy: import_aws_cloudfront2.ViewerProtocolPolicy.REDIRECT_TO_HTTPS,
        ...
        functionAssociations: [
          {
            ...
            eventType: import_aws_cloudfront2.FunctionEventType.VIEWER_REQUEST
          }
        ]
      },
      ...
      httpVersion: import_aws_cloudfront2.HttpVersion.HTTP2_AND_3,
      certificate,
  ...
  createCacheBehaviors(bucket) {
    ...
    for (const pattern of Object.keys(this.getAssetPatterns())) {
      ...
      behaviors[pattern] = {
        ...
        allowedMethods: import_aws_cloudfront2.AllowedMethods.ALLOW_GET_HEAD_OPTIONS,
        ...
        cachePolicy: import_aws_cloudfront2.CachePolicy.CACHING_OPTIMIZED,
        viewerProtocolPolicy: import_aws_cloudfront2.ViewerProtocolPolicy.REDIRECT_TO_HTTPS
      };
    }
    return behaviors;
