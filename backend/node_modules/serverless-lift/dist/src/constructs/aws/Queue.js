...
const _Queue = class extends import_abstracts.AwsConstruct {
  constructor(scope, id, configuration, provider) {
    ...
    const functionTimeout = functionConfig != null ? functionConfig : 6;
    const visibilityTimeout = functionTimeout * 6 + this.getMaximumBatchingWindow();
    const maxRetries = (_a = configuration.maxRetries) != null ? _a : 3;
    let delay = void 0;
    ...
    if (configuration.batchSize !== void 0) {
      ...
      if (configuration.batchSize > 10 && !this.getMaximumBatchingWindow()) {
        throw new import_error.default(
          `Invalid configuration in 'constructs.${this.id}': 'maxBatchingWindow' must be greater than 0 for batchSize > 10, '${this.getMaximumBatchingWindow()}' given.`,
          "LIFT_INVALID_CONSTRUCT_CONFIGURATION"
        );
      }
    }
    ...
    if (alarmEmail !== void 0) {
      ...
      this.alarm = new import_aws_cloudwatch.Alarm(this, "Alarm", {
        ...
        treatMissingData: import_aws_cloudwatch.TreatMissingData.NOT_BREACHING
      });
